...
void playground2::showboard() {
	cout << "\t\t\t\x1B[31m" << playground[0][0] << "\033[0m _____\x1B[31m" << playground[0][2] << "\033[0m _____\x1B[31m" << playground[0][4] << "\033[0m\n";
	cout << "\t\t\t|      |      |  \n";
	cout << "\t\t\t|   \x1B[31m" << playground[1][1] << "\033[0m _\x1B[31m" << playground[1][2] << "\033[0m _\x1B[31m" << playground[1][3] << "\033[0m   |" << " \n";
	cout << "\t\t\t\x1B[31m" << playground[2][0] << "\033[0m _ \x1B[31m" << playground[2][1] << "\033[0m     \x1B[31m" << playground[2][3] << "\033[0m _ \x1B[31m" << playground[2][4] << "\033[0m \n";
	cout << "\t\t\t|   \x1B[31m" << playground[3][1] << "\033[0m _\x1B[31m" << playground[3][2] << "\033[0m _\x1B[31m" << playground[3][3] << "\033[0m   |" << " \n";
	cout << "\t\t\t|      |      |  \n";
	cout << "\t\t\t\x1B[31m" << playground[4][0] << "\033[0m _____\x1B[31m" << playground[4][2] << "\033[0m _____\x1B[31m" << playground[4][4] << "\033[0m \n\n";
}
